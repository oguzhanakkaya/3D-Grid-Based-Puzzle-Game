Shader "FlatKit/Terrain"
{
    Properties
    {
        ...
        // Note(dustyroom): Changed from _BaseColor.
    ...
    SubShader
    {
        ...
        // `UsePass` produces warning:
        // "Shader warning in 'FlatKit/Terrain': Keyword _ALPHATEST_ON declared as global and local. It will be treated 
        // as local keyword."
